...
- 已完成 Terraform GCS Remote State 遷移與配置 (完成)
- 已完成 CI/CD Pipeline 拆分與 IAM 安全強化 (Infra/App Split, Service Accounts) (完成)
...
- **Blog CMS 模組開發** (參考 ADR 0013)
  ...
  - [ ] 在 `frontend/src/app/api/blog` 中，建立 API Routes 或 Server Actions。
  - [ ] 在 Next.js 前端開發 `/blog` 頁面顯示文章 (Public View)。
  - [ ] 在 Next.js 前端開發 `/admin/blog` 頁面，提供文章編輯功能 (Admin View, 使用 **TipTap**)。
