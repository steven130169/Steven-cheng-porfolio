        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex flex-col justify-end items-start md:items-end">
             <div className="flex gap-6 mb-8">
                 <a href="https://github.chiwencheng.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-black/5 rounded-full text-dark-text/60 hover:text-primary hover:bg-primary/10 transition-all"><Github className="h-6 w-6" /></a>
                 <a href="https://cv.chiwencheng.com" target="_blank" rel="noopener noreferrer" className="p-3 bg-black/5 rounded-full text-dark-text/60 hover:text-primary hover:bg-primary/10 transition-all"><Linkedin className="h-6 w-6" /></a>
